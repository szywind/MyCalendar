...
class Event: NSObject, NSCoding {
    ...
    // MARK: Initialization
    init?(_title: String, _date: NSDate, _duration: Int, _location: String?, _detail: String?){
        self.title = _title
        self.date = _date
...
//        }
        ...
        self.init(_title: storedTitle, _date: storedDate, _duration: storedDuration, _location: storedLocation!, _detail: storedDetail!)
